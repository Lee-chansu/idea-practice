            ...
            <div className={form.formContainer}>
                <form>
                    <span>
                        ...
                        <label htmlFor="checkbox">개인정보 수집에 동의합니다.</label>
                    </span>
                    <textarea className={form.text} defaultValue="개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
                                                                1. 수집하는 개인정보
                    ...
                    <span>
                        <input className={form.checkbox} type="checkbox" required />
                        <label htmlFor="checkbox">마케팅 정보 수신에 동의합니다.(선택)</label>
                    </span>
                    <textarea disabled
                    ...
                    <div>
                        <div className={button.buttonWrapper}>
                            <button className={button.button} type="button">
                                <Link to="/join" className={form.link}>가입하기</Link>
                            </button>
                            <button className={button.button} type="button">
                                <Link to="/" className={form.link}>취소 </Link>
                            </button>
                        </div>
                    </div>
                </form>
